...
public class printFrame02 extends JFrame {
...
*/
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					printFrame02 frame = new printFrame02();
	...
	public printFrame02() {
		...
		panel_1.setBounds(698, 14, 169, 39);
		...
		panel_1.add(confirmPrintButton);
			 ...
			 printingPanel.setBackground(SystemColor.inactiveCaptionBorder);
			 ...
			 scrollPane.setBounds(22, 170, 994, 349);
			 ...
			 nameTable.setBounds(46, 113, 211, 36);
			 printingPanel.add(nameTable);
			 
			 JPanel panel = new JPanel();
			 panel.setBackground(SystemColor.inactiveCaptionBorder);
			 panel.setBounds(387, 14, 169, 39);
			 ...
			 btnShow.addActionListener(new ActionListener() {
			 	public void actionPerformed(ActionEvent e) {
			 		...
			 		try {
			 			...
			 			String querytoDelete02="DELETE FROM printBill";
						PreparedStatement pstDelete02=connection.prepareStatement(querytoDelete02);
						
						pstDelete02.execute();
						pstDelete02.close();
						
						String queryLastbill="INSERT INTO printBill SELECT * FROM invoiceTable where orderID=?";
						PreparedStatement pstLastbill=connection.prepareStatement(queryLastbill);
						pstLastbill.setString(1, searchField.getText());
			 		...
			 		catch(Exception e2)
					{
			 		...
			 		try {
			 				String queryGetlastbill="SELECT * FROM printBill";
			 			...
			 			try
						{
						String queryforTable="select itemName,unitPrice,quantity,discount,total from printBill ";
			 ...
			 lblEnterOrderId.setFont(new Font("Tahoma", Font.BOLD, 20));
			 lblEnterOrderId.setBounds(38, 13, 165, 36);
			 contentPane.add(lblEnterOrderId);
			 
			 searchField = new JTextField();
			 searchField.setColumns(10);
			 searchField.setBounds(213, 17, 154, 36);
